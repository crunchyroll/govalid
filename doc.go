...
//
// The generated code abides by gofmt.  It currently supports only
// validating types parseable by the strconv.Parse functions.  Future
// versions will include support for a greater breadth of types.
//
// Usage
//
